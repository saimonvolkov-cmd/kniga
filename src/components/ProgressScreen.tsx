...
{geminiError}
            ...
            <p className="mt-1.5 text-[11.5px] font-bold leading-snug text-ink/55">
              Пайплайн уже прошёл каскад бэкенд /api → YandexART → Gemini → Hugging Face → бесплатный Pollinations (см. строки выше). Проверить каждый провайдер по отдельности можно в панели «Тест генерации» — там же есть кнопки «Проверить YandexART/YandexGPT» и «Без ключа».
            </p>
          </div>
        )}
